...
In this personal project, I will configure Cloud IoT Core and Cloud Pub/Sub to create a Pub/Sub topic and registry on GCP. I will use this topic to ingest data streaming from an IoT device that is simulated to produce real-time temperature.
...
<img width="1168" alt="Screen Shot 2022-01-11 at 7 57 48 AM" src="https://user-images.githubusercontent.com/61028063/148956073-ca774f06-a376-44ce-a4be-8bc057e3ba96.png">
